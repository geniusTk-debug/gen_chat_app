...
export default function Userstate({ userData, logoutHandler }) {
  console.log('from useContext in userstate component',userData)
  return (
        ...
        <div className="user-state">
              <div className="user">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                  ...
                  <div className='auth-btn'>{userData.username}</div>
              </div> 
