...
export default function Content({ view, setView,title, setTitle, isExtended }) {
    ...
    console.log(title, 'title in Contet')
    console.log('view in content com',view)
  return (
    <div className="content-container">
        <ul>
            <li>
                ...
                ( <form onSubmit={switchHandler}>
                    ...
                    <div className="flex-btn">
                        ...
                        <button className='cancel-btn' type='cancel'>back</button>
                    </div>
                </form> )
                :
                ( <button 
            ...
            {/* <li>
                <button className={view === 'history' ? 'active' : ''} onClick={()=>setView('history')}>Chat History  </button>
            </li> */}
            {!!title && 
            ( <li>
                <button 
