...
export default function Content({ view, setView }) {
  ...
  return (
    <div className="content-container">
        <ul>
            <li>
                <button className="plus-btn" onClick={()=>setView('new')}>
            ...
            <li>
                <button className={view === 'now' ? 'active' : ''} onClick={()=>setView('now')}>Now </button>
            </li>
            <li>
